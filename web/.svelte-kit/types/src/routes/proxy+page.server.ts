...
export const actions = {
  create: async ({ request, fetch }: import('./$types').RequestEvent) => handleCreate(request, fetch),
  delete: async ({ request, fetch }: import('./$types').RequestEvent) => handleDelete(request, fetch),
  update: async ({ request, fetch }: import('./$types').RequestEvent) => handleUpdate(request, fetch),
};
