...
if __name__ == "__main__":
    ...
    for epoch in range(1, hyperparams["epochs"] + 1):
        ...
        # Train for one epoch
        train_loss = train_epoch(model, device, train_loader, optimizer, criterion, epoch, tora)
    ...
    test_loss, test_mse, test_rmse, test_mae, test_r2 = validate(
        model, device, test_loader, criterion, scaler, hyperparams["epochs"], tora, split="test"
    )
